<template>
  <div>
    <header class="empower-nav">
      ...
      <div class="nav-tabs">
        <a href="#overview"    class="nav-tab" @click.prevent="scrollTo('overview')">Overview</a>
        ...
        <a href="#demo"        class="nav-tab" @click.prevent="scrollTo('demo')">Demo Prompts</a>
      </div>
      <div class="nav-right">
        <select
          :value="locale"
        ...
        <button type="button" class="btn-pdf" :class="{ 'btn-pdf--loading': isGenerating }" :disabled="isGenerating" @click="downloadPdf('empower-framework-analysis.pdf')">
    ...
    <footer class="site-footer">
      <p><strong>Empower Framework Analysis</strong> &nbsp;·&nbsp; Competitive Intelligence &nbsp;·&nbsp; March 2026 &nbsp;·&nbsp; <strong>Empower by Ringover</strong> &nbsp;·&nbsp; Internal use only</p>
    </footer>
  </div>
</template>
